...
/**
 * Slack-style comment card that slides in from the right. Used for character moments
 * and AI replies across Acts 3, 4, 5, 6.
 */
    ...
    >
      <div className="mb-2 flex items-center gap-2">
        ...
        {tone === 'approve' && !isAi && (
          <span
            className="ml-auto rounded-full px-2 py-0.5 text-[10px] font-semibold uppercase tracking-wider"
            style={{ background: darkMode ? 'rgba(52,211,153,0.12)' : '#D1FAE5', color: '#065F46' }}
          >
            Approves
          </span>
        )}
