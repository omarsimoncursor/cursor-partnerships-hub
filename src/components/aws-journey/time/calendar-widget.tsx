...
interface CalendarWidgetProps {
  currentDay: number;
  /** Label like "Architecture" or "Build". */
  contextLabel?: string;
  /** If provided, widget auto-advances from currentDay to targetDay on mount. */
  targetDay?: number;
  /** Color override for the AWS-orange band */
  accent?: string;
  /** Text color */
  darkMode?: boolean;
}
...
/**
 * A small calendar widget (~150px wide) that shows the current day + date.
 * Each day advance triggers a page-flip animation.
 */
    ...
    >
      ...
      >
        ...
        <div className="px-3 pb-3 pt-2 text-center">
          ...
          <div className="mt-1 text-[11px] font-mono" style={{ color: textMuted }}>
