    ...
    <div className="fixed inset-0 z-50 flex flex-col bg-black/85 backdrop-blur-md overflow-y-auto">
      <div className="shrink-0 px-6 py-5 flex items-center justify-between border-b border-white/5">
        <div className="flex items-center gap-3 text-white">
          ...
          <div>
            <p className="text-sm font-semibold">Worker patch shipped · app-side draft awaiting review</p>
            <p className="text-xs text-white/60">
              Edge mitigations land via wrangler. Security-sensitive code never auto-merges.
            </p>
          </div>
        </div>
        <button
      ...
      <div className="flex-1 flex items-center justify-center p-8">
        <MacbookFrame url="github.com/acme-corp/edge-platform/pull/318">
          <GitHubPRPreview />
        </MacbookFrame>
      </div>
    </div>
