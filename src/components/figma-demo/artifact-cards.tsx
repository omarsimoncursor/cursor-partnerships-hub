...
import { FigmaLogo } from './artifacts/figma-logo';

interface ArtifactCardsProps {
  onOpen: (artifact: 'figma' | 'pr' | 'triage' | 'jira') => void;
}
    ...
    <div className="w-full max-w-5xl mx-auto mt-6">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-3">
        <ArtifactCard
          ...
          iconBg="bg-[#A259FF]/10"
          iconBorder="border-[#A259FF]/30"
          iconColor="text-[#A259FF]"
          label="Figma file"
          refLine="ProductCard@2.3"
          summary="The frame, variables, and 4 annotated drift pins."
          onClick={() => onOpen('figma')}
        />
        <ArtifactCard
          ...
          label="Triage Report"
          refLine="2026-04-16-design-drift-product-card.md"
          summary="4 violations, root cause, WCAG check, fix plan."
        ...
        <ArtifactCard
          ...
          label="Jira Ticket"
          refLine="CUR-4409"
          summary="Design QA · P2 · linked to Figma + PR #163."
          onClick={() => onOpen('jira')}
        />
        <ArtifactCard
          ...
          label="Pull Request"
          refLine="#163 · fix/product-card-token-drift"
          summary="100% Figma match. Awaiting human approval."
          onClick={() => onOpen('pr')}
          primary
        />
      </div>
...
function ArtifactCard({
  icon, iconBg, iconBorder, iconColor, label, refLine, summary, onClick, primary,
}: {
  ...
  return (
    <button
      ...
      className={`group text-left p-4 rounded-xl border ${
        primary
          ? 'border-[#A259FF]/40 bg-[#A259FF]/5 hover:border-[#A259FF]/60 hover:bg-[#A259FF]/10'
    ...
    >
      <div className="flex items-start gap-3">
        ...
        <div className="min-w-0 flex-1">
          ...
          <p className="text-sm font-medium text-text-primary truncate">{refLine}</p>
        </div>
