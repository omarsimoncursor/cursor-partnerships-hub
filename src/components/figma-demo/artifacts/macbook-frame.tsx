...
/**
 * Forked locally from `src/components/sentry-demo/artifacts/macbook-frame.tsx`
 * so the Figma demo can ship its own pixel-perfect URL bar styling without
 * affecting the Sentry demo or the partnership-page MacBook frame in
 * `src/components/shared/macbook-frame.tsx` (which has a different API).
 */
export function MacbookFrame({
  children,
  url = 'figma.com/file/zk2NoMjP4xQwM9pq/Marketing--Shop--ProductCard',
}: MacbookFrameProps) {
  return (
      ...
      <div className="relative">
        ...
        >
          ...
          >
            ...
            {/* Page content */}
            <div className="max-h-[78vh] min-h-[520px] overflow-y-auto bg-white">
              {children}
            </div>
          </div>
        </div>
