...
/**
 * Inline Cursor brand mark for the Snowflake story. Same hexagonal "C" inside
 * a rounded square as the AWS journey, kept in this folder so the Snowflake
 * theme can swap colors without touching shared code.
 */
