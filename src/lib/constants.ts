export const PARTNER_CATEGORIES = {
  ...
  devtools: {
    ...
    partners: [
      ...
      { name: 'PagerDuty', webinar: 'Page Suppression: From P1 Trigger to Auto-Resolve', rationale: "PagerDuty fires the page. Cursor ack's, decides revert vs fix-forward, ships the fix through canary, and resolves the incident — without paging a human.", logo: '/logos/pagerduty.svg' },
