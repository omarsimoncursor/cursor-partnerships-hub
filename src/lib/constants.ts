export const PARTNER_CATEGORIES = {
  ...
  devtools: {
    ...
    partners: [
      ...
      { name: 'PagerDuty', webinar: 'Programmable On-Call: Building an Incident Auto-Pilot with the Cursor SDK', rationale: 'The @cursor/sdk turns the on-call rotation into a programmable auto-pilot you own. PagerDuty fires the page; the SDK, running in your sandboxed worker, spawns triage/revert/comms subagents and ships a tested PR — without paging a human.', logo: '/logos/pagerduty.svg' },
